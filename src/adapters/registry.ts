...
import { CodeBuddyAdapter } from "./codebuddy.ts"
import { createProviderForModel } from "../providers/registry.ts"

export const ALL_ADAPTERS = ["bare-agent", "openclaw", "opencode", "hermes", "jiuwenclaw", "pi", "claude-code", "codebuddy"] as const
...
export function createAdapter(
  ...
  switch (name) {
    ...
    case "codebuddy": return new CodeBuddyAdapter()
    case "bare-agent": {
